...
const settings: ShopSettings = { shop_name: 'Test shop', city: 'Sochi', phone: '', telegram: '', address: '', hours: '', delivery: '', payment: '', legal_name: '', legal_details: '', warranty: '', inquiries_enabled: false };
